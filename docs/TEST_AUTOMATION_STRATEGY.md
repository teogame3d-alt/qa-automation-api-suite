...
- `ApiClient` centralizes base URL handling, timeouts, GET requests, and POST requests.
- Assertion helpers centralize status-code checks, JSON key validation, and list integrity checks.
